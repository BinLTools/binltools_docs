...
- **Step 3.3 Cross-references** (v1.6.1) — *Link Mentions* turns "Table 2.5-1" / "表 2.4-1" in the text into live references to the captions, and "(Smith et al., 2020)" into links to the reference list (run 3.1 Bookmarks first); unclear cases are highlighted for 3.2. *Update All Fields* refreshes TOC and references in one click. The TOC moved to 3.4.
